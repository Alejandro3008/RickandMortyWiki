    ...
    return(
        <>
            <Col sm={12} className="d-flex justify-content-evenly p-2 flex-wrap text-light">
                ...
                {data === null && !noFav && <Error image={'../../public/images/rickError.png'} message={"You dont have a favorite characters"} />}
                {error && noFav && <Error image={'../../public/images/rickError.png'} message={"Ohhh sh!t Morty the page can't load the information."} />}
            </Col>
        </>
    )
}